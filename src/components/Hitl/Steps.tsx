    ...
    >
      ...
      {selectedTool === 0 ? (
        <Accordion >
          ...
          <AccordionDetails sx={{ pt: 0, mt: 0, ml: 2 }}>
            <Typography sx={{ mb: 1 }}>
              <b>2.1</b> Go to the{" "}
        ...
        <Accordion sx={{ mt: 2, p: 0 }}>
          <AccordionSummary sx={{ fontWeight: "normal" }} expandIcon={<ExpandMoreIcon />}>
            <Typography>
...
function CodeBlock({
  ...
  return (
    ...
    >
      ...
      <Typography sx={{ lineHeight: 2 }} fontFamily="monospace" variant="body2">
        {text}
      </Typography>
    </Box>
  );
