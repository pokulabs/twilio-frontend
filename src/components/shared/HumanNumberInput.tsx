...
export function HumanNumberInput({ onChange }: { onChange: (val: string) => void }) {
...
const JoyPhoneInput = forwardRef<HTMLInputElement, JoyInputProps>(function JoyPhoneInput(
    props,
    ref,
  ) {
    return (
  ...
  const CountrySelect = ({ value, onChange, labels, ...rest }: CountrySelectProps) => (
